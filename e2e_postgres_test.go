...
var (
	...
	postgresSANDomainName = os.Getenv("POSTGRES_SAN_DOMAIN_NAME")     // "Cloud SQL Postgres CAS instance connection name, in the form of 'san-test-hessjc-playground-01.csqlconnectortest.com'.
...
func TestPostgresSANDomainConnect(t *testing.T) {
	...
	d, err := cloudsqlconn.NewDialer(ctx,
		...
		cloudsqlconn.WithAdminAPIEndpoint("https://presubmit-22-sqladmin.sandbox.googleapis.com"))
	...
	config.ConnConfig.DialFunc = func(ctx context.Context, _ string, _ string) (net.Conn, error) {
		...
		//return d.Dial(ctx, "invalid-hessjc-playground-01.csqlconnectortest.com")
	}
