...
func (x case_StreamSqlDataResponse_Message) String() string {
	md := file_internal_sqldata_sql_data_service_proto_msgTypes[3].Descriptor()
	if x == 0 {
		return "not set"
	}
	return protoimpl.X.MessageFieldStringOf(md, protoreflect.FieldNumber(x))
...
const file_internal_sqldata_sql_data_service_proto_rawDesc = "" +
	"\n" +
	"'internal/sqldata/sql_data_service.proto\x12\x18google.cloud.sql.v1beta4\x1a\x17google/rpc/status.proto\"\x90\x03\n" +
	...
	"\x11terminate_session\x18\b \x01(\v2*.google.cloud.sql.v1beta4.TerminateSessionH\x00R\x10terminateSessionB\t\n" +
	"\amessage\"o\n" +
	...
	"instanceId\x12\x1d\n" +
	"\n" +
	"session_id\x18\x03 \x01(\tR\tsessionId\"\xc2\x02\n" +
...
var file_internal_sqldata_sql_data_service_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_internal_sqldata_sql_data_service_proto_goTypes = []any{
	...
	(*StartSession)(nil),          // 3: google.cloud.sql.v1beta4.StartSession
	(*ContinueSession)(nil),       // 4: google.cloud.sql.v1beta4.ContinueSession
	(*StreamSqlDataResponse)(nil), // 5: google.cloud.sql.v1beta4.StreamSqlDataResponse
	(*SessionMetadata)(nil),       // 6: google.cloud.sql.v1beta4.SessionMetadata
	(*DataPacket)(nil),            // 7: google.cloud.sql.v1beta4.DataPacket
	(*Ack)(nil),                   // 8: google.cloud.sql.v1beta4.Ack
	(*TerminateSession)(nil),      // 9: google.cloud.sql.v1beta4.TerminateSession
	(*status.Status)(nil),         // 10: google.rpc.Status
}
var file_internal_sqldata_sql_data_service_proto_depIdxs = []int32{
	8,  // 0: google.cloud.sql.v1beta4.StreamSqlDataRequest.ack:type_name -> google.cloud.sql.v1beta4.Ack
	3,  // 1: google.cloud.sql.v1beta4.StreamSqlDataRequest.start_session:type_name -> google.cloud.sql.v1beta4.StartSession
	4,  // 2: google.cloud.sql.v1beta4.StreamSqlDataRequest.continue_session:type_name -> google.cloud.sql.v1beta4.ContinueSession
	7,  // 3: google.cloud.sql.v1beta4.StreamSqlDataRequest.data:type_name -> google.cloud.sql.v1beta4.DataPacket
	9,  // 4: google.cloud.sql.v1beta4.StreamSqlDataRequest.terminate_session:type_name -> google.cloud.sql.v1beta4.TerminateSession
	8,  // 5: google.cloud.sql.v1beta4.StreamSqlDataResponse.ack:type_name -> google.cloud.sql.v1beta4.Ack
	6,  // 6: google.cloud.sql.v1beta4.StreamSqlDataResponse.session_metadata:type_name -> google.cloud.sql.v1beta4.SessionMetadata
	7,  // 7: google.cloud.sql.v1beta4.StreamSqlDataResponse.data:type_name -> google.cloud.sql.v1beta4.DataPacket
	9,  // 8: google.cloud.sql.v1beta4.StreamSqlDataResponse.terminate_session:type_name -> google.cloud.sql.v1beta4.TerminateSession
	1,  // 9: google.cloud.sql.v1beta4.SessionMetadata.supported_features:type_name -> google.cloud.sql.v1beta4.SqlDataFeature
	10, // 10: google.cloud.sql.v1beta4.TerminateSession.status:type_name -> google.rpc.Status
	2,  // 11: google.cloud.sql.v1beta4.SqlDataService.StreamSqlData:input_type -> google.cloud.sql.v1beta4.StreamSqlDataRequest
	5,  // 12: google.cloud.sql.v1beta4.SqlDataService.StreamSqlData:output_type -> google.cloud.sql.v1beta4.StreamSqlDataResponse
...
func file_internal_sqldata_sql_data_service_proto_init() {
	...
	file_internal_sqldata_sql_data_service_proto_msgTypes[3].OneofWrappers = []any{
