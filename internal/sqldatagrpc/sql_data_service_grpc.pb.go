...
package sqldatagrpc
import sqldatapb "cloud.google.com/go/cloudsqlconn/internal/sqldata"
...
func (c *sqlDataServiceClient) StreamSqlData(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[sqldatapb.StreamSqlDataRequest, sqldatapb.StreamSqlDataResponse], error) {
	...
	x := &grpc.GenericClientStream[sqldatapb.StreamSqlDataRequest, sqldatapb.StreamSqlDataResponse]{ClientStream: stream}
	return x, nil
}
...
func _SqlDataService_StreamSqlData_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(SqlDataServiceServer).StreamSqlData(&grpc.GenericServerStream[sqldatapb.StreamSqlDataRequest, sqldatapb.StreamSqlDataResponse]{ServerStream: stream})
}
...
var SqlDataService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/sqldata/sql_data_service.proto",
}
